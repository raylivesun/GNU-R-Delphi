...
type
  ...
  protected
    ...
    { get sleep about the normal ... }

    procedure TObjGetSleep(Sleep, Normal: ByteInt); Byte;
    procedure TObjGetBuffer(Buffer, Normal: ByteInt); Byte;
    procedure TObjGetCheckr(Checkr, Normal: ByteInt); Byte;

    {static of normal sleep ...}
